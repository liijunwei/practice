...
PASS 测试用例.3 输入2个字符组成一个单词, 应该输出 num_line: 1 num_word: 1
num_char: 3 PASS 测试用例.4 输入2个字符组成两个单词, 在同一行, 应该输出
num_line: 1 num_word: 2 num_char: 4 PASS 测试用例.5 输入2个字符组成两个单词,
在不同行, 应该输出 num_line: 2 num_word: 2 num_char: 4
*/
