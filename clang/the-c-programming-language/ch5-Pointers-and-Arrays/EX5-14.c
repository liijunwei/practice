...
// gcc -g ch5-Pointers-and-Arrays/EX5-14.c && cat
// ch5-Pointers-and-Arrays/sample-input.md | ./a.out gcc -g
// ch5-Pointers-and-Arrays/EX5-14.c && cat
// ch5-Pointers-and-Arrays/sample-input.md | ./a.out -n gcc -g
// ch5-Pointers-and-Arrays/EX5-14.c && cat
// ch5-Pointers-and-Arrays/sample-input.md | ./a.out -r gcc -g
// ch5-Pointers-and-Arrays/EX5-14.c && cat
// ch5-Pointers-and-Arrays/sample-input.md | ./a.out -nr
