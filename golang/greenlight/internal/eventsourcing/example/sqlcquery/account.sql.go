...
SELECT id, balance, available, pending, created_at, updated_at, version from accounts where id = $1
`
...
SELECT id, balance, available, pending, created_at, updated_at, version from accounts where id = $1 for update
`
